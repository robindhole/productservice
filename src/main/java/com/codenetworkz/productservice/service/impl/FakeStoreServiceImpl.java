...
public class FakeStoreServiceImpl implements ProductService {
   ...
   final private RestTemplate restTemplate;
    ...
    public Product create(String title, String description, Double price, Category category, String imageUrl) {
        ...
        FakeStoreProductRequestResponseDto responseDto = restTemplate.postForObject(BaseURL, productFakeStoreDto, FakeStoreProductRequestResponseDto.class);
       return productMapper.toProduct(responseDto );
    }

    @Override
    public List<Product> getAllProduct() {
        FakeStoreProductRequestResponseDto[] responseDtos = restTemplate.
    ...
    public Product getOneProduct(Long productId) {
     FakeStoreProductRequestResponseDto responseDto=  restTemplate.
    ...
    public List<Product> getProductCategoryByName(String name) {
        ...
        FakeStoreProductRequestResponseDto[] response = restTemplate.
    ...
    public Product updateProduct(Product product,Long productId) {
        Product oneProduct = getOneProduct(productId);
        FakeStoreProductRequestResponseDto request = productMapper.toFakeStoreResponseDto(product);
        ...
        if(oneProduct!=null){
          String url=  BaseURL +"{id}";
            ...
            HttpEntity<FakeStoreProductRequestResponseDto> response = restTemplate.exchange(url, HttpMethod.PUT, requestEntity, FakeStoreProductRequestResponseDto.class, param);
